...
import { getPlanLabel, resolvePackage } from "../../shared/lib/packagePricing.js";
import {
  dedupeCompanyPurchases,
  buildSubscriptionDisplay,
  syncCompanySubscription,
} from "../../shared/lib/packagePurchases.js";
...
async function activatePackage(purchase) {
  ...
  if (purchase.companyId) {
    // const { enforceCompanyJobVisibility } = await import("../../shared/lib/jobVisibility.js");
